                                    ...
                                    child: SingleChildScrollView(
                                      ...
                                      child: DataTable(
                                        ...
                                        rows: const <DataRow>[
                                          ...
                                          DataRow(
                                            cells: <DataCell>[
                                              DataCell(Text('Тушеное мясо\n(консервы)')),
                                              DataCell(Text('100')),
                                            ],
                                          ),
                                          DataRow(
                                            cells: <DataCell>[
                                              DataCell(Text('Масло растительное')),
                                              DataCell(Text('25')),
                                            ],
                                          ),
                                          DataRow(
                                          ...
                                          DataRow(
                                            cells: <DataCell>[
                                              DataCell(Text('Сгущенное молоко')),
                                              DataCell(Text('40')),
                                            ],
                                          ),
                                          DataRow(
                                          ...
                                          DataRow(
                                            cells: <DataCell>[
                                              DataCell(Text('Картофель (для супа)')),
                                              DataCell(Text('75')),
                                            ],
                                          ),
                                          DataRow(
                                            cells: <DataCell>[
                                              DataCell(Text('Картофель\n(для второго блюда)')),
                                              DataCell(Text('350')),
                                            ],
                                          ),
                                          DataRow(
                                     ...
                                     RichText(
                                      text: TextSpan(
                                        ...
                                        children: [
                                          ...
                                          TextSpan(
                                            text: "меню. Пишется то, что вы будете готовить, например: манная каша, бутерброд с вареньем, чай с сахаром.\n",
                                          ),  
                                          TextSpan(
                                            text: "\nВторой столбик:",
                                            style: TextStyle(fontWeight: FontWeight.bold),
                                          ...
                                          TextSpan(
                                            text: " раскладка на 1 человека. Перечисляются ингредиенты, которые понадобятся для приготовления. Например: манная крупа, булка, варенье, чай, сахар, соль, сгущенка.\n",
                                          ),  
                                          TextSpan(
                                            text: "\nТретий столбик:",
                                            style: TextStyle(fontWeight: FontWeight.bold),
                                          ...
                                          TextSpan(
                                            text: " вес продуктов на 1 человека. Напротив каждого продукта пишем необходимое количество в расчете на одного человека (см. раскладку).\n",
                                          ),  
                                          TextSpan(
                                            text: "\nЧетвертый столбик:",
                                            style: TextStyle(fontWeight: FontWeight.bold),
                                          ...
                                          TextSpan(
                                            text: " вес на отряд. Пишется кол-во граммов на весь отряд.\n",
                                          ),  
                                          TextSpan(
                                            text: "\nВ конце таблицы",
                                            style: TextStyle(fontWeight: FontWeight.bold),
                                          ...
                                          TextSpan(
                                            text: " подводится итог, что и сколько надо с собой взять. Но не стоит принимать безоговорочно получившиеся цифры. Помните, что соль и сахар обычно добавляются по вкусу. Чай рассчитываем следующим образом: берем 4 пакетика в чайник и 5 пакетиков, если вы завариваете в котле.",
                                          ),                                   
                                        ]
                                      )
                                    ),
                                     ...
                                     RichText(
                                      text: TextSpan(
                                        ...
                                        children: [
                                          ...
                                          TextSpan(
                                            text: "Перловую крупу перед употреблением промывают в холодной воде, затем засыпают в несоленый кипяток и после закипания варят минут сорок на медленном огне, следя за тем, чтобы вода не выкипела. Солят кашу, когда она уже готова, после чего ее надо немного подержать на огне и снимать.\n",
                                          ), 
                                          TextSpan(
