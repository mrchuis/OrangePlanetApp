                                  ...
                                  children: <Widget>[
                                    RichText(
                                        text: TextSpan(
                                          ...
                                          TextSpan(
                                            text:
                                                "Самыми важными предметами для ориентирования являются карта и компас. Компас позволяет определить направление на север и двигаться на местности по выбранному азимуту. ",
                                          ),
                                          TextSpan(
                                            text: "Азимут ",
                                            style: TextStyle(
                                          ...
                                          TextSpan(
                                            text:
                                                "– угол между направлением на север и заданным направлением на объект. Компас устанавливается горизонтально, вне зоны действия электро- и радиоприборов (это могут быть мобильный телефон, радио, рельсы, просто ключи в кармане). Красная стрелка указывает на север."
                                    ...
                                    RichText(
                                      text: TextSpan(
                                          ...
                                          children: [
                                            ...
                                            TextSpan(
                                              text:
                                                  "обозначаются все гидрографические (водные) объекты, как то: реки, болота, озера и т.д.\n",
                                            ),
                                            TextSpan(
                                              text: "\nЖелтым цветом ",
                                              style: TextStyle(
                                            ...
                                            TextSpan(
                                              text:
                                                  "– открытые пространства (просеки, насыпи и т.д.).\n",
                                            ),
                                            TextSpan(
                                              text: "\nЧерным цветом ",
                                              style: TextStyle(
                                            ...
                                            TextSpan(
                                              text:
                                                  "– дороги и искусственные объекты (линии электропередач, дома и т.д.).\n",
                                            ),
                                            TextSpan(
                                              text: "\nЗеленым цветом ",
                                              style: TextStyle(
                                            ...
                                            TextSpan(
                                              text:
                                                  "– растительность и чем темнее и насыщенней цвет, тем гуще лес и труднее проходимость.\n",
                                            ),
                                            TextSpan(
                                              text: "\nКрасным ",
                                              style: TextStyle(
                                            ...
                                            TextSpan(
                                              text:
                                                  "– обозначение дистанции. Если крестик, то опасный для прохождения участок.\n",
                                            ),
                                            TextSpan(
                                              text: "\nКоричневым цветом ",
                                              style: TextStyle(
                                            ...
                                            TextSpan(
                                              text:
                                                  "– все элементы рельефа (ямы, холмы, обрывы, овраги, россыпи камней и т.д.).\n",
                                            ),
                                            TextSpan(
                                              text: "\nГоризонталь ",
                                              style: TextStyle(
                                            ...
                                            TextSpan(
                                              text:
                                                  "– замкнутая линия, которая соединяет все точки рельефа, находящиеся на одной высоте, это как бы горизонтальный «срез» земли.\n",
                                            ),
                                            TextSpan(
                                              text:
                                            ...
                                            TextSpan(
                                              text:
                                                  ", показывает разницу высот между горизонталями. Например, если на карте холм изображён тремя горизонталями, то при Н=5 м, его высота будет 15 метров.\n",
                                            ),
                                            TextSpan(
                                              text: "\nБергштрих ",
                                              style: TextStyle(
                                            ...
                                            TextSpan(
                                              text:
                                                  "– короткая, перпендикулярная горизонтали чёрточка, показывающая направление стока воды, то есть, даёт нам понять холм или яма изображены на карте.\n",
                                            ),
                                          ]),
                                    ),
                                    Image.asset(
                                    ...
                                    RichText(
                                      text: TextSpan(
                                          ...
                                          children: [
                                            TextSpan(
                                              text:
                                                  "⦁ По солнцу. В полдень солнце достигает высшей точки своего подъема – ",
                                            ),
                                            TextSpan(
                                              text: "зенита",
                                              style: TextStyle(
                                            ...
                                            TextSpan(
                                              text:
                                                  ", тени становятся самыми короткими за день. Если встать спиной к солнцу, то впереди север, сзади – юг, справа – восток, слева – запад, как на карте (а в южном полушарии все наоборот).\n",
                                            ),
                                          ]),
                                    ),
                                    Image.asset(
                                    ...
                                    RichText(
                                      text: TextSpan(
                                          ...
                                          children: [
                                            ...
                                            TextSpan(
                                              text:
                                                  ": созревают быстрее с южной стороны. ",
                                            ),
                                            TextSpan(
                                              text: "\n\nЛишайники и мхи",
                                              style: TextStyle(
                                            ...
                                            TextSpan(
                                              text:
                                                  ": с северной стороны камней и деревьев. ",
                                            ),
                                            TextSpan(
                                              text: "\n\nСмола",
                                              style: TextStyle(
                                            ...
                                            TextSpan(
                                              text:
                                                  ": на хвойных деревьях выступает с севера.\n\nРанней весной ",
                                            ),
                                            TextSpan(
                                              text: "снег тает ",
                                              style: TextStyle(
