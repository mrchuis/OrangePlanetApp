                                      ...
                                      children: <Widget>[
                                        RichText(
                                            text: TextSpan(
                                              ...
                                              TextSpan(
                                                text:
                                                    "тошнота, рвота, боль в области желудка и кишечника, диарея",
                                                style: TextStyle(
                                                    fontWeight:
                                                        FontWeight.bold),
                                              ),
                                      ...
                                      children: <Widget>[
                                        ...
                                        RichText(
                                            text: TextSpan(
                                              ...
                                              TextSpan(
                                                text:
                                                    " Если этого нет, необходимо срочно обеспечить покой (как физический так и эмоциональный), дать приток свежего воздуха (открыть окна и двери настеж), снять стесняющую одежду, уложить пострадавшего на ровную твёрдую поверхность и не давать двигаться. Либо помочь пострадавшему принять такое положение: руками опереться на спинку стула/стола и перенести вес тела. Таким образом вы подключите дополнительные мышцы спины и облегчите дыхание.",
                                              ),
                                            ])),
                                      ]),
                                ),
                                      ...
                                      children: <Widget>[
                                        ...
                                        RichText(
                                            text: TextSpan(
                                              ...
                                              TextSpan(
                                                text:
                                                    "руку пострадавшего на противоположной стороне от поражения поднять вверх, согнуть в локтевом суставе, положив предплечье на голову. Наложить давящую повязку, зафиксировав бинт на плече поднятой руки. Либо зафиксировать в подмышечной области на противоположной стороне, если поднять руку не представляется возможным.\n",
                                              ),
                                            ])),
                                        Image.asset(
                                        ...
                                        RichText(
                                            text: TextSpan(
                                              ...
                                              TextSpan(
                                                text:
                                                    "Крайне не рекомендуется применять этот метод, т.к. он максимально травматичный. Сделайте все, для того чтобы не пришлось применять его.\n"
                                        ...
                                        RichText(
                                            text: TextSpan(
                                              ...
                                              TextSpan(
                                                text:
                                                    "Помощь при венозных кровотечениях. Наложение давящей повязки и воздействие холодом.\n",
                                                style: TextStyle(
                                                    fontWeight:
                                                        FontWeight.bold),
                                              ),
                                              TextSpan(
                                                text:
                                                    "Давящая повязка накладывается ниже раны, поскольку венозная кровь поднимается от периферических сосудов к сердцу. Такая давящая повязка состоит из нескольких стерильных марлевых салфеток или не размотанного бинта (тампон), на которые накладывают эластичный бинт в несколько слоёв. О правильности наложения повязки свидетельствует остановка кровотечения, но сохранение пульсации ниже места прижатия.",
                                              ),
                                            ])),
                                        Image.asset(
                                      ...
                                      children: <Widget>[
                                        RichText(
                                            text: TextSpan(
                                              ...
                                              TextSpan(
                                                text:
                                                    "В зависимости от повреждающего фактора ожоги разделяют на ",
                                              ),
                                              TextSpan(
                                                text:
                                                    "термические (горячей жидкостью, пламенем, раскаленным металлом), электрические и химические.\n",
                                                style: TextStyle(
                                                    fontWeight:
                                                        FontWeight.bold),
                                              ),
                                        ...
                                        rows: const <DataRow>[
                                          DataRow(
                                            cells: <DataCell>[
                                              ...
                                              DataCell(Text('1 шт.')),
                                              DataCell(
                                                  Text('Измеряем температуру')),
                                              DataCell(
                                                  Text('Хорошо упаковать')),
                                            ],
                                          ),
                                          DataRow(
                                            cells: <DataCell>[
                                          ...
                                          DataRow(
                                            cells: <DataCell>[
                                              ...
                                              DataCell(Text(
                                                  'Следить за герметичностью упаковки\nи сохранением стерильности')),
                                            ],
                                          ),
                                          DataRow(
                                            cells: <DataCell>[
                                          ...
                                          DataRow(
                                            cells: <DataCell>[
                                              ...
                                              DataCell(Text('1 фл.')),
                                              DataCell(
                                                  Text('Обработка краев ран')),
                                              DataCell(Text(
                                                  'Не использовать в саму рану и на\nместах с длительным наложением\nповязок, т.к. возможен ожог')),
                                            ],
                                          ),
                                          DataRow(
                                            cells: <DataCell>[
                                          ...
                                          DataRow(
                                            cells: <DataCell>[
                                              ...
                                              DataCell(Text('1 шт.')),
                                              DataCell(Text(
                                                  'Остановка арт. кровотечения')),
                                              DataCell(Text(
                                                  'Обязательно на одежду/ткань;\nуказать время наложения')),
                                            ],
                                          ),
                                          DataRow(
                                            cells: <DataCell>[
                                          ...
                                          DataRow(
                                            cells: <DataCell>[
                                              ...
                                              DataCell(Text('1 шт.')),
                                              DataCell(Text(
                                                  'Хорошо помогает в ситуациях, когда\nнужно «прогреть» определенную\nчасть тела')),
                                              DataCell(Text(
                                                  'Не допускать попадание на\nслизистые или в раны')),
                                            ],
                                          ),
                                          DataRow(
                                            cells: <DataCell>[
                                              ...
                                              DataCell(Text('1 фл.')),
                                              DataCell(Text(
                                                  'При синдроме сухого глаза. 1-2 капли\nзакапывают 4-8 раз в сутки в\nконъюнктивальный мешок')),
                                              DataCell(Text(
                                                  'Не рекомендуется при ношении\nмягких контактных линз.')),
                                            ],
                                          ),
                                          DataRow(
                                            cells: <DataCell>[
                                        ...
                                        rows: const <DataRow>[
                                          DataRow(
                                            cells: <DataCell>[
                                              ...
                                              DataCell(Text(
                                                  'При отравлениях: 1 таблетка на 10 кг. веса;\nможно размельчить')),
                                              DataCell(Text(
                                                  'Другие препараты не применять,\nт.к. уголь адсорбент')),
                                            ],
                                          ),
                                          DataRow(
                                            cells: <DataCell>[
                                              DataCell(
                                                  Text('Дротаверин (Но-Шпа)')),
                                              DataCell(Text('20 табл.')),
                                              DataCell(Text(
                                                  'При спазмах, коликах, болях в животе.\n1 табл. 3 р./день')),
                                              DataCell(Text('')),
                                            ],
                                          ),
                                          DataRow(
                                          ...
                                          DataRow(
                                            cells: <DataCell>[
                                              ...
                                              DataCell(Text('5 пак.')),
                                              DataCell(Text(
                                                  'При диарее. Содержимое 1 пак. развести в 1/2\nстакане слегка тёплой воды, пить небольшими\nглотками')),
                                              DataCell(Text('')),
                                            ],
                                          ),
                                          DataRow(
                                            cells: <DataCell>[
                                              ...
                                              DataCell(Text(' 2 пак.')),
                                              DataCell(Text(
                                                  'При диарее. Содержимое одного пакетика\nразвестив 1 л. воды, пить небольшими\nглотками')),
                                              DataCell(Text(
                                                  'Пить после прекращени\nприступов диареи')),
                                            ],
                                          ),
                                          DataRow(
                                            cells: <DataCell>[
                                              ...
                                              DataCell(Text('20 табл.')),
                                              DataCell(Text(
                                                  'При киш инфекциях. Принимать по 1 табл.\n4 р./день(в первый день — до 6 табл.)')),
                                              DataCell(Text('')),
                                            ],
                                          ),
                                        ],
                                        ...
                                        rows: const <DataRow>[
                                          ...
                                          DataRow(
                                            cells: <DataCell>[
                                              ...
                                              DataCell(Text('')),
                                              DataCell(Text(
                                                  'При болях в сердце. Сублингвально (под язык),\nпо 1 таблетке 2–3 раза в день.')),
                                              DataCell(Text('')),
                                            ],
                                          ),
                                        ],
                                        ...
                                        rows: const <DataRow>[
                                          DataRow(
                                            cells: <DataCell>[
                                              ...
                                              DataCell(Text('20 табл.')),
                                              DataCell(Text(
                                                  'При непродуктивном (без макроты)\nкашле. 1 табл 3 р./день')),
                                              DataCell(Text('')),
                                            ],
                                          ),
                                          DataRow(
                                            cells: <DataCell>[
                                              ...
                                              DataCell(Text('20 табл.')),
                                              DataCell(Text(
                                                  'Раствор для полоскания: 4 табл в 1\nстакане воды. При ангине полоскать\n6-8 р./день')),
                                              DataCell(Text('')),
                                            ],
                                          ),
                                          DataRow(
                                            cells: <DataCell>[
                                              ...
                                              DataCell(Text('1 фл.')),
                                              DataCell(Text(
                                                  'При рините. 1 доза в каждый носовой\nход 3 р./сут.')),
                                              DataCell(Text(
                                                  'Содержит растительные компоненты! Нельзя\nприменять, если есть аллергия на\nразличные растения (деревья, цветы, травы)')),
                                            ],
                                          ),
                                          DataRow(
                                            cells: <DataCell>[
                                        ...
                                        rows: const <DataRow>[
                                          ...
                                          DataRow(
                                            cells: <DataCell>[
                                              ...
                                              DataCell(Text(
                                                  'При мокнущих, плохозаживающих повреждениях кожи ')),
                                              DataCell(Text(
                                                  'Сразу не бинтовать, дать подсохнуть')),
                                            ],
                                          ),
                                        ],
                                      ),
