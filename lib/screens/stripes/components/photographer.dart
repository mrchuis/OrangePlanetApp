                                    ...
                                    RichText(
                                      text: TextSpan(
                                        ...
                                        children: [
                                          ...
                                          TextSpan(
                                            text: "состоит из пластика или сплава магния, не пропускает свет.\n",
                                          ),
                                          TextSpan(
                                            text: "\nОбъектив ",
                                            style: TextStyle(fontWeight: FontWeight.bold),
                                          ...
                                          TextSpan(
                                            text: " (1) состоит из системы линз. С помощью него изображение объектов съемки проецируется на матрицу.\n",
                                          ),
                                          TextSpan(
                                            text: "\nДиафрагма ",
                                            style: TextStyle(fontWeight: FontWeight.bold),
                                          ...
                                          TextSpan(
                                            text: " (2) – это перегородка, которая находится внутри объектива, а также имеет вид лепестков. Они образуют отверстие, диаметр которого можно регулировать.\n",
                                          ),
                                          TextSpan(
                                            text: "\nПризма (пентапризма) ",
                                            style: TextStyle(fontWeight: FontWeight.bold),
                                          ...
                                          TextSpan(
                                            text: " (4) – элемент, который переворачивает изображение.\n",
                                          ),
                                          TextSpan(
                                            text: "\nВидоискатель ",
                                            style: TextStyle(fontWeight: FontWeight.bold),
                                          ...
                                          TextSpan(
                                            text: " (5) – своего рода «глазок», через который фотограф видит будущий снимок.\n",
                                          ),
                                          TextSpan(
                                            text: "\nМатрица (сенсор) ",
                                            style: TextStyle(fontWeight: FontWeight.bold),
                                          ...
                                          TextSpan(
                                            text: " (8)  чувствует свет, заменяет в устройстве зеркального фотоаппарата пленку.\n",
                                          ),
                                          TextSpan(
                                            text: "\nКарта памяти ",
                                            style: TextStyle(fontWeight: FontWeight.bold),
                                          ...
                                          TextSpan(
                                            text: "бережно хранит наши фотографии.\n",
                                          ),
                                          TextSpan(
                                            text: "\nЗатвор ",
                                            style: TextStyle(fontWeight: FontWeight.bold),
                                          ...
                                          TextSpan(
                                            text: " (6) – это механические шторки, которые находятся между сенсором и зеркалом фотокамеры. В момент съемки они временно открываются таким образом, чтобы свет попал на матрицу.",
                                          ),                                          
                                        ]
                                      ),
                                    ),
                                    ...
                                    RichText(
                                      text: TextSpan(
                                        ...
                                        children: [
                                          ...
                                          TextSpan(
                                            text: "– это время, на которое открывается затвор и приподнимается зеркало.  Чем меньше выдержка, тем меньше света попадет на матрицу. Чем больше время выдержки, тем больше света.\n",
                                          ),
                                          TextSpan(
                                          ...
                                          TextSpan(
                                            text: "– чувствительность матрицы к свету. Максимальное ISO – матрица становится более чувствительной, и можно сделать снимок даже при малом свете. Но чем больше ISO, тем более «шумная», «зернистая» фотография.\n",
                                          ),
                                          TextSpan(
                                            text: "\nЭкспозиция ",
                                            style: TextStyle(fontWeight: FontWeight.bold),
                                          ...
                                          TextSpan(
                                            text: "– ключевое понятие в фотографии. Формируется подбором комбинации выдержки и диафрагмы, которые еще называются «экспопара». Задача фотографа –  подобрать комбинацию так, чтобы обеспечить необходимое количество света для создания изображения на матрице.\n",
                                          ),
                                          TextSpan(
                                          ...
                                          TextSpan(
                                            text: "– это та точка, на которую вы «навели резкость».",
                                          ),                                        
                                        ]
                                      ),
                                    ),
                                  ...
                                  children: <Widget>[
                                    RichText(
                                      text: TextSpan(
                                        ...
                                        children: [
                                          TextSpan(
                                            text: "Экспонометр и флешметр ",
                                            style: TextStyle(fontWeight: FontWeight.bold),
                                          ),
                                          TextSpan(
                                            text: "– устройства для определения световых условий съёмки.\n",
                                          ),
                                          TextSpan(
                                          ...
                                          TextSpan(
                                            text: "Для съёмки в условиях недостаточной освещённости используются различные осветительные приборы и отражатели. Наиболее массовыми среди них стали фотовспышки.\n",
                                          ),
                                          TextSpan(
                                            text: "\nШтативы ",
                                            style: TextStyle(fontWeight: FontWeight.bold),
                                          ...
                                          TextSpan(
                                            text: "используются для предотвращения «смаза» при недостаточной освещённости, съемке панорам, при больших выдержках, для установки дополнительного осветительного оборудования, для многократной съемки на один кадр и т. д.\n",
                                          ),
                                          TextSpan(
                                            text: "\nСветофильтры ",
                                            style: TextStyle(fontWeight: FontWeight.bold),
                                          ...
                                          TextSpan(
                                            text: "используются для компенсации цветовых и пространственных недостатков освещения, получения специальных эффектов.",
                                          ),                                        
                                        ]
                                      ),
                                    ),
                                    ...
                                    RichText(
                                      text: TextSpan(
                                        ...
                                        children: [
                                          ...
                                          TextSpan(
                                            text: "(от лат. compositio) означает составление, соединение, сочетание различных частей в единое целое в соответствии с какой-либо идеей.\n",
                                          ),                                      
                                        ]
                                      ),
                                    ),
