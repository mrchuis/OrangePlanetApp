                                    ...
                                    RichText(
                                      text: TextSpan(
                                        ...
                                        children: [
                                          ...
                                          TextSpan(
                                            text: "- объединяет действия гребцов по четырем командам: «Протянуться!», «Оттолкнуть нос!», «Уключины вставить!» и «Весла разобрать!» (на шлюпках с распашными веслами по этой команде гребцы выполняют действия и по команде «Весла!»). ",
                                          ), 
                                          TextSpan(
                                          ...
                                          TextSpan(
                                            text: "«На воду!» Командир шлюпки ",
                                            style: TextStyle(fontWeight: FontWeight.bold),
                                          ),
                                          TextSpan(
                                            text: "должен подавать команды отчетливо, громким голосом и обязательно в момент, когда лопасти весел находятся в воде и еще не доведены: до траверза. Поданная команда исполняется гребцами после окончания гребка. ",
                                          ),
                                          TextSpan(
                                          ...
                                          TextSpan(
                                            text: ", по которой гребцы поднимают лопасти из воды и выравнивают их в горизонтальном положении параллельно поверхности воды. При этом весла устанавливаются перпендикулярно диаметральной плоскости шлюпки нерабочей стороной лопасти вверх. ",
                                          ),
                                          TextSpan(
                                          ...
                                          TextSpan(
                                            text: "движения шлюпки или полной ее остановки подается команда ",
                                          ),
                                          TextSpan(
                                            text: "«Весла в воду!» ",
                                            style: TextStyle(fontWeight: FontWeight.bold),
                                          ...
                                          TextSpan(
                                            text: "По этой команде гребцы опускают 1/3 лопасти ребром в воду и, удерживая валек на высоте груди, корпусом налегают на него.",
                                          ),
                                          TextSpan(
                                          ...
                                          TextSpan(
                                            text: "«Шабаш!»  «Табань обе!» ",
                                            style: TextStyle(fontWeight: FontWeight.bold),
                                          ), 
                                          TextSpan(
                                            text: "По этой команде гребцы одновременно заносят весла к корме, опускают лопасти в воду и начинают грести в обратном направлении, давая шлюпке ход назад. Никогда не следует подавать эту команду на шлюпке, имеющей ход вперед.",
                                          ),
                                          TextSpan(
                                            text: "\n\n«Весла по борту!» ",
                                            style: TextStyle(fontWeight: FontWeight.bold),
                                          ...
                                          TextSpan(
                                            text: "По этой команде гребцы одновременно и быстро заносят лопасти к корме (при движении шлюпки назад — к носу) так, чтобы они были прижаты к борту в вертикальном положении. ",
                                          ),
                                          TextSpan(
                                            text: "\n\nДля возобновления, гребли предварительно подается команда ",
                                          ),
                                          TextSpan(
                                            text: "«Суши весла!» «Навались!» ",
                                            style: TextStyle(fontWeight: FontWeight.bold),
                                          ),
                                          TextSpan(
                                            text: "или ",
                                          ...
                                          TextSpan(
                                            text: "Эти команды подаются для увеличения или уменьшения скорости хода шлюпки. При выполнении этих команд установившийся темп гребли не меняется.",
                                          ),
                                          TextSpan(
                                            text: "\n\n«Весла на валек!» ",
                                            style: TextStyle(fontWeight: FontWeight.bold),
                                          ...
                                          TextSpan(
                                            text: "Гребцы, не вставая с мест, вынимают весла из уключин и ставят их вертикально лопастями вверх, развернув лопасти вдоль шлюпки. Внешняя рука гребца, вытянутая вдоль шлюпки, держит весло за «кожу», а другая рука — за валек. Корпус гребца при этом должен быть прямой, а голова повернута лицом в сторону кормы. Эта команда подается на шлюпках с вальковыми веслами для приветствия, при прохождении особо узких мест, линии финиша на гонках, а также при посадке в шлюпку большого числа людей. Как только минует надобность в этом приеме, подают команду ",
                                          ),
                                          TextSpan(
                                            text: "«Весла!» «Береги весла!» ",
                                            style: TextStyle(fontWeight: FontWeight.bold),
                                          ),
                                          TextSpan(
                                            text: "Команда подается при опасении, что весла могут быть повреждены, задев за какой-нибудь предмет. Гребцы внимательно следят за лопастью своего весла, при необходимости несколько втягивают весло внутрь шлюпки или поднимают лопасть, пропуская гребок. ",
                                          ),
                                          TextSpan(
                                            text: "\n\n«Весла под рангоут!» ",
                                            style: TextStyle(fontWeight: FontWeight.bold),
                                          ...
                                          TextSpan(
                                            text: "(на шлюпках с вальковыми) или ",
                                          ),
                                          TextSpan(
                                          ...
                                          TextSpan(
                                            text: "По этой команде гребцы поднимают весла лопастями вверх, опускают их в воду и, упираясь рукоятями весел в грунт, стараются сдвинуть шлюпку с мели. Для продолжения гребли подается команда «Весла!» и т. д.",
                                          ),
                                          TextSpan(
                                    ...
                                    RichText(
                                      text: TextSpan(
                                        ...
                                        children: [
                                          ...
                                          TextSpan(
                                            text: "прямым курсом заданное направление удерживается по отдаленному неподвижному предмету, по компасу или створу. Возникающие отклонения от курса старшина шлюпки немедленно исправляет небольшим поворотом руля.",
                                          ), 
                                          TextSpan(
                                            text: "\n\nУправление шлюпкой ",
                                            style: TextStyle(fontWeight: FontWeight.bold),
                                          ...
                                          TextSpan(
                                            text: "по отдаленному предмету заключается в том, что ее форштевень должен все время удерживаться в створе с предметом.",
                                          ), 
                                          TextSpan(
                                          ...
                                          TextSpan(
                                            text: "необходимо курс шлюпки располагать так, чтобы дойти до намеченной точки кратчайшим путем. Угол сноса будет зависеть от скорости течения, скорости движения шлюпки и других факторов. Он подбирается опытным путем, сообразуясь с обстановкой, но в каждом случае курс располагается под некоторым углом к течению. Следуя на течении по створам, нос шлюпки не будет направлен на створ.",
                                          ), 
                                          TextSpan(
                                          ...
                                          TextSpan(
                                            text: "«Правая (левая) — в воду!» ",
                                            style: TextStyle(fontWeight: FontWeight.bold),
                                          ), 
                                          TextSpan(
                                            text: "При наличии движения руль перекладывается в сторону того же борта. По окончании поворота подается команда «Обе — на воду!»-При необходимости сделать разворот шлюпки на месте гребцам каждого борта может быть подана отдельная команда. Первая команда обычно подается правому борту. В этом случае следует подать команды: ",
                                          ), 
                                          TextSpan(
                                            text: "«Правая табань!» (или «Правая в воду!»), «Левая на воду!»\n\nПодход шлюпки к кораблю ",
                                            style: TextStyle(fontWeight: FontWeight.bold),
                                          ), 
                                          TextSpan(
                                            text: "осуществляется с кормы под углом 30 — 40° к его диаметральной плоскости. Учитывая инерцию движения, заранее подают команду «Шабаш!» и направляют шлюпку параллельно курсу корабля. Загребной ближнего к кораблю борта отпорным крюком задерживает корму шлюпки у трапа, а баковые принимают с корабля трос для крепления.",
                                          ), 
                                          TextSpan(
                                          ...
                                          TextSpan(
                                            text: "осуществляется таким же образом. Подойдя к пирсу, удерживают шлюпку отпорными крюками и высылают одного из баковых на берег для приема и крепления фалиней.",
                                          ),  
                                        ]
                                      ),
                                    ),
