                                ...
                                child: Column(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Text(
                                        ...
                                        "\n6. Сдать 2 лагерных гимна под гитару (Будь готов, Поехали скорей) + 2 любые песни боем + 2 любые перебором. Необходимо при этом хотя бы проговаривать слова песни.\n"
                                    ...
                                    children: <Widget>[
                                      RichText(
                                          text: TextSpan(
                                            ...
                                            TextSpan(
                                              text:
                                                  "— акустическая гитара, напоминающая классическую, но приспособленная к использованию металлических струн.\n",
                                            ),
                                            TextSpan(
                                              text: "\n3. Дредноут (вестерн) ",
                                              style: TextStyle(
                                            ...
                                            TextSpan(
                                              text:
                                                  "— гитара с металлическими струнами и увеличенным корпусом характерной «прямоугольной» формы. Обладает повышенной по сравнению с классическим корпусом громкостью и преобладанием низкочастотных компонентов в тембре.\n",
                                            ),
                                            TextSpan(
                                              text: "\n4. Джамбо ",
                                              style: TextStyle(
                                            ...
                                            TextSpan(
                                              text:
                                                  "— инструмент с металлическими струнами, большим корпусом, плоской верхней декой и округлыми линиями обвода.\n",
                                            ),
                                          ])),
                                    ]),
                              ),
                                    ...
                                    children: <Widget>[
                                      RichText(
                                          text: TextSpan(
                                            ...
                                            TextSpan(
                                              text:
                                                  " — самый известный приём игры на гитаре. Заключается в ударном звукоизвлечении (отсюда и название), резким, но скользящим ударом — по отдельным, рядом расположенным, струнам, либо по всем сразу.\n",
                                            ),
                                          ])),
                                      Text(
                                      ...
                                      RichText(
                                          text: TextSpan(
                                            ...
                                            TextSpan(
                                              text:
                                                  " — извлечение звука с помощью последовательного чередования (перебора) струн. Исполняется путём последовательного защипывания разных струн несколькими пальцами.\n",
                                            ),
                                          ])),
                                      Text(
                                      ...
                                      RichText(
                                          text: TextSpan(
                                            ...
                                            TextSpan(
                                              text:
                                                  ". Проще перебора и не придумаешь. Играется он следующим образом:",
                                            ),
                                          ])),
                                      Text(
                                        "\nБас-3-2-1-2-3\n",
                                      ...
                                      RichText(
                                          text: TextSpan(
                                            ...
                                            TextSpan(
                                              text:
                                                  ". Это уже слегка продвинутый перебор, но освоить его должен каждый. Он имеет следующую структуру:",
                                            ),
                                          ])),
                                      Text(
                                        "\nБас-3-2-3-1-3-2-3\n",
                                      ...
                                      RichText(
                                          text: TextSpan(
                                            ...
                                            TextSpan(
                                              text:
                                                  ". Перебор имеет необычную структуру:",
                                            ),
                                          ])),
                                      Text(
                                        "\nБас-3-(2-1)-3\n",
