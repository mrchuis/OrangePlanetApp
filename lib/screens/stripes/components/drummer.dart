                                        ...
                                        RichText(
                                          text: TextSpan(
                                            ...
                                            children: [
                                              ...
                                              TextSpan(
                                                text:
                                                    "– слова, предметы или действия, обозначающие какие-то важные понятия для мира, страны, общества, коллектива и т.д. Символы подчеркивают общие ценности, объединяют людей на основе общих целей и заповедей. Символами, например, являются следопытский галстук, законы и заповеди следопытов, Праздник первого костра и др.\n",
                                              ),
                                              TextSpan(
                                                text: "\nРитуалы ",
                                                style: TextStyle(
                                              ...
                                              TextSpan(
                                                text:
                                                    "– традиционные действия, носящие символический характер. Ритуалы в лагере – это подъем флага, произнесение лагерного девиза, церемония посвящения в следопыты и др. У каждого государства есть свои символы и ритуалы.\n",
                                              ),
                                              TextSpan(
                                                text:
                                              ...
                                              TextSpan(
                                                text:
                                                    "выглядит так: золотой двуглавый орел на красном щите; над орлом — три короны Петра I (над головами — две малые и над ними — одна большего размера); в лапах орла — скипетр и держава; на груди орла на красном щите — всадник, поражающий копьем змея.\n",
                                              ),
                                              TextSpan(
                                                text:
                                              ...
                                              TextSpan(
                                                text:
                                                    ": прямоугольное полотнище из трех равновеликих горизонтальных полос: верхней — белого, средней — синего и нижней — красного цвета.\n",
                                              ),
                                              TextSpan(
                                                text:
                                              ...
                                              TextSpan(
                                                text:
                                                    "создан на основе советского гимна (музыка Александра Александрова /1939 год/, слова Сергея Михалкова /2000 год/).\n",
                                              ),
                                              TextSpan(
                                                  text:
                                              ...
                                              TextSpan(
                                                text:
                                                    "(музыка Григория Рейхтмана, слова Владислава Крапивина /1970 год/).\n",
                                              ),
                                              TextSpan(
                                                text:
                                              ...
                                              TextSpan(
                                                text:
                                                    "Полый фанерный или пластиковый корпус, внутри которого находится пружина, сбоку – отверстие для выхода воздуха. Обручи сверху и снизу закрепляют натянутую мембрану (из кожи или пластика); обручи скрепляются зажимами. К зажимам присоединяется ремень с гнездами для палочек и пряжкой-регулятором длины ремня.\n",
                                              ),
                                              TextSpan(
                                                text:
                                              ...
                                              TextSpan(
                                                text:
                                                    "Существуют походное и боевое положения барабанов. Чтобы перевести барабан в другое положение, барабанщик должен знать правила переходов. Голосовые сигналы в виде счета подает ведущий барабанщик.\n",
                                              ),
                                              TextSpan(
                                                text: "\nПоходное положение.\n",
                                                style: TextStyle(
                                              ...
                                              TextSpan(
                                                text:
                                                    "Барабанщик стоит, расставив ноги. Барабан висит у него на правом боку, ремень перекинут через левое плечо. Правая рука барабанщика согнута и лежит на верхней части корпуса барабана, левая с зажатыми палочками (палочки соединены валетом, параллельно ногам) вытянута и прижата к левому боку.\n",
                                              ),
                                              TextSpan(
                                                text:
                                              ...
                                              TextSpan(
                                                text:
                                                    "правая рука барабанщика берется за нижний обод.\n",
                                              ),
                                              TextSpan(
                                                text: "«Два»: ",
                                                style: TextStyle(
                                              ...
                                              TextSpan(
                                                text:
                                                    "правая рука берется за обод барабана и переводит его вперед, в боевое положение. Левая рука по-прежнему вытянута и прижата к левому боку.\n",
                                              ),
                                              TextSpan(
                                                text: "«Три»: ",
                                                style: TextStyle(
                                              ...
                                              TextSpan(
                                                text:
                                                    "левая рука с палочками переносится на корпус барабана. При этом палочки берутся обеими руками так, чтобы при начале игры палочки не пришлось перекручивать.\n",
                                              ),
                                              TextSpan(
                                                text:
                                                    "\n\"Боевое\" положение.\n",
                                              ...
                                              TextSpan(
                                                text:
                                                    "Барабанщик стоит, расставив ноги. Барабан висит перед ним, ремень перекинут через левое плечо. Руки с палочками (сложенными параллельно) лежат на мембране.\n",
                                              ),
                                              TextSpan(
                                                text:
                                              ...
                                              TextSpan(
                                                text:
                                                    "правая рука берется за край обруча, дальний от барабанщика. Левая рука с параллельно сжатыми палочками опускается и вытягивается вдоль левого бока.\n",
                                              ),
                                              TextSpan(
                                                text: "«Два»: ",
                                                style: TextStyle(
                                              ...
                                              TextSpan(
                                                text:
                                                    "правая рука переводит барабан в походное положение и остается держать низ обруча. Левая рука остается неподвижной.\n",
                                              ),
                                              TextSpan(
                                                text: "«Три»: ",
                                                style: TextStyle(
                                              ...
                                              TextSpan(
                                                text:
                                                    "правая рука сгибается и кладется на верхнюю часть обруча.\n",
                                              ),
                                              TextSpan(
                                                text: "\nЗнаки барабанщиков ",
                                                style: TextStyle(
                                              ...
                                              TextSpan(
                                                  text:
                                                      "Поднятая над головой вверх правая палочка, полукруг вверху и резкий бросок палочки вниз: "),
                                              TextSpan(
                                                text: "«Снять игру!»\n",
                                                style: TextStyle(
                                                    fontStyle:
                                              ...
                                              TextSpan(
                                                  text:
                                                      "Скрещенные над головой две палочки: "),
                                              TextSpan(
                                              ...
                                              TextSpan(
                                                  text:
                                                      "Команда подается при боевом положении сводного отряда. Барабанщики разнимают палочки, не поднимая их с мембраны, так, чтобы в каждой руке оказалась палочка.\n"),
                                              TextSpan(
                                                text: "«Начали!». ",
                                                style: TextStyle(
                                                    fontStyle:
                                              ...
                                              TextSpan(
                                                  text:
                                                      "Команда для одновременного начала игры."),
                                            ],
                                          ),
                                        ),
                                      ]),
